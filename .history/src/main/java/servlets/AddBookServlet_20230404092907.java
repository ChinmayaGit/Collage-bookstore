...
import com.miniproject.constant.BookStoreConstants;
import com.miniproject.constant.db.BooksDBConstants;
import com.miniproject.model.Book;
import com.miniproject.model.UserRole;
import com.miniproject.service.BookService;
import com.miniproject.service.impl.BookServiceImpl;
import com.miniproject.util.StoreUtil;
...
public class AddBookServlet extends HttpServlet {
    ...
    public void service(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
        ...
        String customId=String.valueOf(1000000000 + r.nextInt(2000000000));
        try {
            String uniqueID = customId.toString();
